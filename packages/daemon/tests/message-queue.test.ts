...
describe('SessionMessageQueue', () => {
  ...
  test('queue full: enqueue beyond maxQueueSize throws error', () => {
    ...
    queue.enqueue({ sessionId: 'sess-1', source: 'user', userId: 'u1', text: 'msg1' })
    ...
    queue.enqueue({ sessionId: 'sess-1', source: 'user', userId: 'u1', text: 'msg2' })
    queue.enqueue({ sessionId: 'sess-1', source: 'user', userId: 'u1', text: 'msg3' })

    expect(() => {
      queue.enqueue({ sessionId: 'sess-1', source: 'user', userId: 'u1', text: 'msg4' })
  ...
  test('cancelQueued: cancel a queued message removes it from queue', async () => {
    ...
    const msgId = queue.enqueue({ sessionId: 'sess-1', source: 'user', userId: 'u1', text: 'second' })
  ...
  test('cancelQueued: after processing completes, returns not_found', async () => {
    ...
    const queue = new SessionMessageQueue('sess-1', processor)
    const msgId = queue.enqueue({ sessionId: 'sess-1', source: 'user', userId: 'u1', text: 'msg' })
  ...
  test('cancelActive: cancel currently processing message aborts', async () => {
    ...
    const queue = new SessionMessageQueue('sess-1', processor)
    const msgId = queue.enqueue({ sessionId: 'sess-1', source: 'user', userId: 'u1', text: 'long-running' })
  ...
  test('enqueue returns a messageId', () => {
    ...
    const msgId = queue.enqueue({ sessionId: 'sess-1', source: 'user', userId: 'u1', text: 'test' })
  ...
  test('processor errors do not stop drain', async () => {
    ...
    const queue = new SessionMessageQueue('sess-1', processor)
    queue.enqueue({ sessionId: 'sess-1', source: 'user', userId: 'u1', text: 'fail' })
    queue.enqueue({ sessionId: 'sess-1', source: 'user', userId: 'u1', text: 'succeed' })
...
describe('MessageQueueManager', () => {
  test('enqueue creates queue per session and returns messageId', async () => {
    ...
    manager.enqueue('sess-1', { sessionId: 'sess-1', source: 'user', userId: 'u1', text: 'a' })
    manager.enqueue('sess-2', { sessionId: 'sess-2', source: 'user', userId: 'u2', text: 'b' })
  ...
  test('cancelQueued searches all queues', async () => {
    ...
    manager.enqueue('sess-1', { sessionId: 'sess-1', source: 'user', userId: 'u1', text: 'first' })
    await new Promise(resolve => setTimeout(resolve, 10))
  ...
  test('dispose cleans up all queues', async () => {
    ...
    const manager = new MessageQueueManager(processor)
    manager.enqueue('sess-1', { sessionId: 'sess-1', source: 'user', userId: 'u1', text: 'msg' })
    manager.enqueue('sess-2', { sessionId: 'sess-2', source: 'user', userId: 'u2', text: 'msg' })
